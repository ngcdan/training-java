...
public enum VolumeUnit {
  ...
  CUBIC_MILLIMETER("mm3", VolumeUnit.CUBIC_MILLIMETER_SCALE), CUBIC_CENTIMETER("cm3",
    VolumeUnit.CUBIC_CENTIMETER_SCALE), LITER("l", VolumeUnit.LITER_SCALE, "dm3"), CUBIC_METER("m3",
    VolumeUnit.CUBIC_METER_SCALE, "cbm"), CUBIC_KILOMETER("km3", VolumeUnit.CUBIC_KILOMETER_SCALE);
