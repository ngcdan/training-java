...
public enum DistanceUnit {
  MM("mm", DistanceUnit.MILLIMETER_SCALE),
  CM("cm", DistanceUnit.CENTIMETER_SCALE),
  DM("dm", DistanceUnit.DECIMETER_SCALE),
  M("m", DistanceUnit.METER_SCALE),
  KM("km", DistanceUnit.KILOMETER_SCALE),
  INCH("inch", DistanceUnit.METER_SCALE, "in");
