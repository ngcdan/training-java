...
public class ExchangeRateConverter {
  ...
  public double convertBid(double amount, String fromCurrency, String toCurrency) {
    if(fromCurrency == null) throw new IllegalArgumentException("Currency must be not null");
    if(toCurrency == null) throw new IllegalArgumentException("Currency must be not null");
