...
public class AsyncExampleUnitTest {
  ...
  public void syncExampleUnitTest() {
    ...
    completableFuture.thenApply(fetchUsers).thenAcceptAsync(displayer, service);
  ...
  public void asyncExampleUnitTest() {
    ...
    CompletableFuture<List<Long>> completableFuture = CompletableFuture.supplyAsync(supplierIDs);
    completableFuture.thenCompose(fetchUsers).thenAcceptAsync(displayer, service);
  ...
  public void asyncExample2UnitTest() {
    ...
    CompletableFuture<List<Long>> completableFuture = CompletableFuture.supplyAsync(supplierIDs);
    completableFuture.thenComposeAsync(fetchUsers, service2).thenAcceptAsync(displayer, service1);
  ...
  public void syncExceptionExample3UnitTest() {
    ...
    CompletableFuture<List<Long>> supply = CompletableFuture.supplyAsync(supplierIDs);
    CompletableFuture<List<Long>> exceptionally = supply.whenComplete((ids, e) -> {
      if(e != null) {
        e.printStackTrace();
      }
    });
  ...
  public void syncExceptionExample4UnitTest() {
    ...
    CompletableFuture<List<Long>> supply = CompletableFuture.supplyAsync(supplierIDs);
    CompletableFuture<List<Long>> exceptionally = supply.handle((ids, e) -> {
      if(e != null) {
        e.printStackTrace();
        return List.of();
      } else {
