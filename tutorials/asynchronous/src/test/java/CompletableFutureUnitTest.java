...
public class CompletableFutureUnitTest {
  ...
  public void firstCompletableFutureUnitTest() throws ExecutionException, InterruptedException {
    ...
    CompletableFuture<Void> completableFuture1 = CompletableFuture.runAsync(() -> System.out
      .println("[CompletableFuture.runAsync(runnable)] - Running in the thread " + Thread.currentThread().getName()));

    Future<?> future = service.submit(
      () -> System.out.println("[Executor.submit()] - Running in the thread " + Thread.currentThread().getName()));

    CompletableFuture<Void> completableFuture2 = CompletableFuture.runAsync(() -> System.out.println(
